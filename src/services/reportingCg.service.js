...
//     const { operators, hses, attachments, createdBy, ...data } = body;

//     if (!createdBy) {
//         return apiResponse(true, [{ msg: "createdBy est requis", field: "createdBy" }]);
//     }

//     // Vérification CG entrant (si modèle existe)
...
//     const { operators, hses, attachments, updatedBy, ...data } = body;
...
//                 where: { id },
//                 include: { operators: true, hses: true, attachments: true }
//             });
//         });
...
//                 case 'createdAt':
//                 case 'updatedAt': {
//                     // value attendu : "2024-01-01,2024-12-31"
//                     const [dateStart, dateEnd] = value.split(',');
//                     if (dateStart && dateEnd) {
...
//         // ✅ Filtre secondaire optionnel (ex: initiateur en plus d'une date)
//         if (filter2 && value2) {
//             switch (filter2) {
//                 case 'createdBy':
